    ...
    <div className="space-y-6">
        ...
        <div className="flex flex-wrap items-end justify-between gap-4">
          ...
          {allIn?.likely ? (
            <div className="text-right">
              ...
              <div className="text-xl font-semibold tabular-nums text-[#8a5a2b] dark:text-[#d1a06a]">
      ...
      {waived.length ? (
        <details className="group">
          <summary className="cursor-pointer list-none rounded-lg border border-[#e7e1d5] bg-white/60 px-4 py-2 text-sm font-medium text-neutral-600 dark:border-[#2b3234] dark:bg-[#1b2022]/60 dark:text-neutral-300">
          ...
          <div className="mt-3 grid gap-3 sm:grid-cols-2">
            {waived.map((f) => (
              <div
                key={f.id}
                className="rounded-lg border border-[#e7e1d5] bg-white/70 p-3 text-sm dark:border-[#2b3234] dark:bg-[#1b2022]/70"
              >
