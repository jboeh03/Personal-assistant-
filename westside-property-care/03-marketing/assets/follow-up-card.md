...
| Spec | Value |
|---|---|
| Finished size | 4" × 6" postcard — the standard size that qualifies for USPS First-Class postcard postage, if mailed |
...
One ask, `[PHONE]`, stated once. No separate banner, no "call now" — the whole card is the ask.
