...
> is held open for projects and estimates, so urgent things usually get handled — that's a real
...
>
> Grill and outdoor kitchen deep clean — **$249 and up**. Window well cleanout — **$49 and up**,
> when I'm already on the property. No membership required for either.

> ### Next step
>
> I'll walk the property with you — about forty minutes — and give you the number for your place
> while I'm standing there.
>
> `[OWNER FIRST NAME]` · `[PHONE]` · `[EMAIL]` · `[URL]`
> WPC513
...
One ask: walk the property together, about forty minutes, price given on the spot. This matches
`messaging.md` §3's pricing-page row exactly ("Walk the property with me — about forty minutes")
rather than a generic "learn more," which `voice.md`'s CTA rules ban outright.
