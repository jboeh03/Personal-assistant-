...
- "Do they have any attachment to specific contractors or brands for the roof work, or is 'licensed, professional, receipted' what matters?"
...
- Sellers are motivated, organized, and will hit every contract date.

## 4. What NOT to concede or say

- No admissions about the roof beyond the inspection report's own words (nothing like "storm-damaged," "failing," "needs replacement").
- **No specific dollar figure** — not even "around $X" — until both sellers have signed the written response.
- Do not reveal urgency, the separation, or anything about the sellers' finances.
- No promises beyond the notice items; no open-ended "we'll take care of whatever comes up."
- No mention of the insurance question — seller-side matter only.
...
| Worries about lender caps or how a credit gets papered | Size the credit to their **actual** closing costs; Branch A or C with the number checked against the loan officer |
| Ambiguous / can't reach him | No harm — the humans pick the branch anyway; the Skeptic's appraisal-hedge logic favors B when in doubt |

---
*Companion files: [RESPONSE_MEMO.md](RESPONSE_MEMO.md) (branch logic) · [RESPONSE_EMAIL_DRAFTS.md](RESPONSE_EMAIL_DRAFTS.md) (transmittal drafts) · [DRAFT_RESPONSE_LANGUAGE.md](DRAFT_RESPONSE_LANGUAGE.md) (form language).*
