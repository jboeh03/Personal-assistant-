# DRAFT RESPONSE LANGUAGE — Defect Notice Form, 6840 Stonington Rd
...
## BRANCH A — buyers OK with money-in-lieu (H2: radon performed + roof/gutter credit)

**DRAFT — FOR AMY'S REVIEW**

**Form action:** Check option **(d)** and fill the blank:

> (d) Seller offers to pay Buyer's settlement charges and/or other fees at Closing in an amount up to **$______** *(suggest **$8,500** — mid-point stance on the v2 most-likely band for roof pkg + chimney + gutters ($6,600–$11,100, [REPAIR_ESTIMATE.md](REPAIR_ESTIMATE.md)); confirm against buyers' actual closing costs + prepaids via their lender)*, in lieu of the corrections identified as items RS-1, RS-2, RS-3, RS-4, RS-5, RS-6, and EG-2 in Buyer's Defect Notice, subject to the initialed amendment below.

**Initialed amendment (quotable paragraph, attach/initial per form practice):**
...
## BRANCH B — buyers want the repairs performed ((b)-amended)

**DRAFT — FOR AMY'S REVIEW**

**Form action:** Check option **(b)** — Seller agrees to complete the corrections **as amended** — and attach/initial the following amendment:
...
## BRANCH C — fallback: pure (d), all-in credit (radon unbookable, or money branch collapses to cash-only)
...
## DO NOT SAY (any branch, any channel — calls, texts, emails)

- **No admissions about roof condition beyond the inspection report.** Do not characterize the roof as "storm-damaged," "failing," or "needing replacement" — the report's findings are the entire agreed factual record, and extra words become disclosure/claim material.
- **No open-ended repair promises.** Never "we'll take care of whatever needs doing" or "whatever the roofer finds." Scope is exactly what the signed writing says — nothing more.
- **No verbal-only agreements.** §28: modifications are invalid "unless in writing and signed by all parties." A phone-call handshake on 08/11 that isn't papered by end of 08/12 is an auto-terminated contract, not a deal.
- **No commitments on dates or dollars** beyond what's in the signed branch language — especially no promised install dates before the radon installer has confirmed one.
- **No discussion of the insurance angle** with the buyers' side; it is a seller-side cost-offset question only.

---
*Amounts trace to: [REPAIR_ESTIMATE.md](REPAIR_ESTIMATE.md) (v2 house-specific bands: all-in ~$4,350 low / ~$7,900–$12,900 most likely / ~$18,300 high; $8,500 Branch-A suggestion; $10,500 Branch-C suggestion — supersedes the 08/07 COUNCIL_VERDICT figures of $5,500/$7,500) · [contract-timeline-analysis.md](../research/contract-timeline-analysis.md) (IPC caps, (d) framing, §28) · [costs-gutters-radon-v2.md](../research/costs-gutters-radon-v2.md) (ODH licensure, retest <4.0 language).*
